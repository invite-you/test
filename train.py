...
from src.dataset import ShipDataset, Resizer, Normalizer, Augmenter, collater
...
def get_args():
    ...
    parser.add_argument("--data_path", type=str, default=r"C:\Users\sync\dev\simplified_rbox_cnn\dataset\train", help="the root folder of dataset")
...
def train(opt):
    ...
    training_params = {"batch_size": 3,#opt.batch_size * num_gpus,
                       "shuffle": True,
                       "drop_last": True,
                       "collate_fn": collater,
                       "num_workers": 4}

    test_params = {"batch_size": 3,#opt.batch_size,
                   "shuffle": False,
                   "drop_last": False,
                   "collate_fn": collater,
                   "num_workers": 4}
